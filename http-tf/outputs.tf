...
output "best_pokemon" {
  description = "Learn about the bestest pokemon"
  value       = data.http.bestPokemon.response_body
}

output "best_pokemon_json" {
  description = "Learn about the bestest pokemon"
  value       = jsondecode(data.http.bestPokemon.response_body)
}
